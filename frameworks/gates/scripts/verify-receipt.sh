...
# A silently-failed cd would leave this verifying a receipt against whatever tree
# the caller happened to be in, and reporting success for it.
cd "$ROOT" || fail "cannot enter repo root '$ROOT'"
